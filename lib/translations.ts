...
const ar: typeof fr = {
  ...
  categories: {
    ...
    items: [
      ...
      "مونتاج الفيديو والحركة",
      "إنتاج الموسيقى والمزج",
      "تطوير الويب والتطبيقات",
      "إدارة وسائل التواصل الاجتماعي",
      "التصوير والتعديل",
      "الترجمة (عربي/فرنسي/إنجليزي)",
      "الدروس الخصوصية والمساعدة الأكاديمية",
      "الاستشارات المالية",
      "المساعدة القانونية والإدارية",
      "التعليق الصوتي والبودكاست",
      "ثلاثي الأبعاد والرسوم المتحركة",
      "كتابة المحتوى والكوبي رايتنج",
      "إدخال البيانات والمساعد الافتراضي",
      "تنظيم الفعاليات",
