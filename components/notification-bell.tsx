...
import { Bell, MessageSquare, ShoppingBag, RefreshCw, Star, Check } from "lucide-react"
...
type NotifType = "new_message" | "new_order" | "order_status" | "new_review"
          ...
          {notifications.length === 0 ? (
            ...
            notifications.map((n) => {
              ...
              return (
                ...
                >
                  <span className={`mt-0.5 shrink-0 ${TYPE_COLORS[type]}`}>
                    {TYPE_ICONS[type]}
                  </span>
